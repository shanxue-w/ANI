...
if __name__ == "__main__":
    ...
    train_loss_file = open(os.path.join('logs', f"train_loss_{args.train_limit}1.txt"), "w")
    val_loss_file = open(os.path.join('logs', f"val_loss_{args.train_limit}1.txt"), "w")
    ...
    for epoch in range(epochs):
        ...
        if val_loss < best_val_loss:
            ...
            torch.save(model.state_dict(), os.path.join('models', f"best_model_fno_{args.train_limit}_final1.pth"))
