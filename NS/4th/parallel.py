...
from ANI_NS_4th import ODEPairDataset
from ANI_NS_4th import NavierStokes, A, total_loss  # 假设这些类已经按原来定义好了
    ...
    for epoch in range(epochs):
        ...
        if rank == 0:
            ...
            if val_loss < best_val_loss:
                ...
                torch.save(model.module.state_dict(), os.path.join("models", "best_model.pth"))
