...
class Pendulum(ANIBASE):
    ...
    def forward(self, x):
        ...
        k3 = self.block_tau(self.block_tau(self.block_tau(u, dts/3.0), dts/3.0), dts/3.0)

        # 最终组合
        return 1.0/24.0 * k1 - 16.0/15.0 * k2 + 81.0/40.0 * k3
    ...
    def predict(self, x):
        ...
        u  = 1.0/24.0 * k1 - 16.0/15.0 * k2 + 81.0/40.0 * k3
