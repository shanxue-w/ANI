...
os.makedirs("../../results/Lorenz-stenflo", exist_ok=True)
...
plot_error(abs_ANI_2th, abs_ANI_4th, abs_resnet, '../../results/Lorenz-stenflo/rel_error_200.pdf')
...
def plot_trajectory(traj, filename, title='Trajectory'):
    ...
    ax.grid(True, color='0.8', linestyle='--', linewidth=0.5) 
...
plot_trajectory(lorenz_basedata, '../../results/Lorenz-stenflo/lorenz_true_plot.pdf')

lorenz_truedata = np.load('dataset/lorenz_stenflo_plot.npy')
plot_trajectory(lorenz_truedata, '../../results/Lorenz-stenflo/lorenz_stenflo_plot.pdf', title='Lorenz Stenflo True Trajectory')

lorenz_4thdata = np.load('dataset/lorenz_4th_plot.npy')
plot_trajectory(lorenz_4thdata, '../../results/Lorenz-stenflo/lorenz_4th_plot.pdf', title='Lorenz Stenflo 4th Order Neural ODE')
...
plt.savefig("../../results/Lorenz-stenflo/data_3d_new.pdf", format='pdf', bbox_inches='tight', pad_inches=0, dpi=300, transparent=True)
plt.close()