...
class LorenzStenflo(ANIBASE):
    def __init__(self, N0_SCHEME: N0, input_dim: int, output_dim: int, hidden_layers: int = 4, hidden_dim: int = 32):
...
def plot_trajectories(NN_traj, true_traj, title="Trajectories Comparison", i = 0):
    ...
    # save them as .mat file
    sio.savemat(f"ANI_Lorenz_stenflo_2th_{i}_h32.mat", {"NN_traj": NN_traj})
