...
class LorenzStenflo(ANIBASE):
    def __init__(self, N0_SCHEME: N0, input_dim: int, output_dim: int, hidden_layers: int = 4, hidden_dim: int = 20):
...
def plot_trajectories(NN_traj, true_traj, title="Trajectories Comparison", i = 0):
    ...
    sio.savemat(f"ANI_Lorenz_stenflo_4th_{i}_h20.mat", {"NN_traj": NN_traj})
