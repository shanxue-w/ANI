...
from ANI import MLP  # project MLP
import numpy as np
...
def plot_trajectories(NN_traj, true_traj, title="Trajectories Comparison", i = 0):
    ...
    sio.savemat(f"ANI_Lorenz_stenflo_base_{i}_h32.mat", {"NN_traj": NN_traj})
...
if __name__ == "__main__":
    ...
    # Init model
    model = RK4Baseline(input_dim=4, output_dim=4, hidden_layers=4, hidden_dim=32).to(device)
