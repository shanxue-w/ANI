...
def plot_error(ANI_2th, ANI_3th, ANI_4th, resnet, filename):
    ...
    plt.plot(resnet[1:200], label='KAN-RK4', color="#0072B2", linewidth=2)
    plt.plot(ANI_2th[1:200], label='ANI_2th', color="#009E73", linewidth=2)
    # plt.plot(ANI_3th[1:200], label='ANI_3th')
    plt.plot(ANI_4th[1:200], label='ANI_4th', color="#E69F00", linewidth=2)
    plt.legend()
...
plt.figure(figsize=(8, 6))
plt.plot(abs_resnet[1:400], label='KAN-RK4', color="#0072B2", linewidth=2)
plt.plot(abs_ANI_2th[1:400], label='ANI-2', color="#009E73", linewidth=2)
plt.plot(abs_ANI_4th[1:400], label='ANI-4', color="#E69F00", linewidth=2)
plt.yscale('log')
plt.legend()
...
# fig = plt.figure(figsize=(8, 8))
ax  = fig.add_subplot(111, projection='3d')
ax.plot(u_traj[:2000, 0], u_traj[:2000, 1], u_traj[:2000, 2], color="#1f77b4", linewidth=0.4)
# ax.plot(u_traj[:2000, 0], u_traj[:2000, 1], u_traj[:2000, 2], color="gray")
...
plt.savefig("data_3d.pdf", format='pdf', bbox_inches='tight', pad_inches=0, dpi=300, transparent=True)
plt.close()
