...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load(f"models/best_model_fno_{args.train_limit}_final1.pth", map_location=device))
    ...
    # 写入文件，每行写一个时间点的误差
    with open(f"traj_error_{args.train_limit}1.txt", "w") as f:
