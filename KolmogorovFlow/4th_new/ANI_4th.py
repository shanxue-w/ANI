...
class A(N0):
    def __init__(self, Nx=256, Ny=512, Lx=1.0, Ly=2.0, Re=1e4, Cs=0.18, device='cuda:3'):
        super().__init__()
...
if __name__ == "__main__":
    ...
    model = NavierStokes(N0_SCHEME=A(Nx=128, Ny=128, Lx=1.0, Ly=1.0, device=device), modes1=64, modes2=64, width=64, dt=0.01, device=device)
    # 多卡并行
