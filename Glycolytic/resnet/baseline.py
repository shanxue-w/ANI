...
class ResNetBaseline(nn.Module):
    ...
    def F(self, x:torch.Tensor):
        ...
        # 5.207  + 0. * x0 + 1.095 * x1 + 21.883 * x2 + -24.44310367 * x3 + -19.398 * x4 + -1.49 * x5 + 11.778 * x6,
...
if __name__ == "__main__":
    ...
    # # 初始化模型
    model = ResNetBaseline(input_dim=8, output_dim=7, hidden_layers=6, hidden_dim=32).to(device)
