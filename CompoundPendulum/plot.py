...
plt.figure(figsize=(8, 6))
plt.plot(u_true[200:1000, 0], u_true[200:1000, 1], color="#0072B2", label='True', linewidth=2)
plt.plot(u_2th[200:1000, 0], u_2th[200:1000, 1], color="#009E73", marker='o', label='ANI-2', markersize=4, linestyle='None')
...
plt.figure(figsize=(8, 6))
plt.plot(u_true[200:1000, 0], u_true[200:1000, 1], color="#0072B2", label='True', linewidth=2)
plt.plot(u_4th[200:1000, 0], u_4th[200:1000, 1], color='#E69F00', marker='o', label='ANI-4', markersize=4, linestyle='None')
plt.legend(loc="lower left")
plt.xlabel(r'$\theta_1$', fontsize=14)
plt.ylabel(r'$\omega_1$', fontsize=14)
plt.tight_layout()
...
plt.figure(figsize=(8, 6))
plt.plot(u_true[200:1000, 0], u_true[200:1000, 1], color="#0072B2", label='True', linewidth=2)
plt.plot(u_base[200:1000, 0], u_base[200:1000, 1], color='#D55E00', marker='o', label='Baseline', markersize=4, linestyle='None')
plt.legend(loc="lower left")
plt.xlabel(r'$\theta_1$', fontsize=14)
plt.ylabel(r'$\omega_1$', fontsize=14)
plt.tight_layout()
