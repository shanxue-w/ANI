...
plot_error(abs_ANI_2th, abs_ANI_3th, abs_ANI_4th, abs_resnet, 'rel_error_1000.pdf')
...
plt.tight_layout()
plt.savefig('data_traj.pdf', format='pdf', bbox_inches='tight', dpi=300, transparent=True)
plt.close()
