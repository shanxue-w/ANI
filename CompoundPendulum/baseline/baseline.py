...
class ResNetBaseline(nn.Module):
    def __init__(self, input_dim=8, output_dim=7, hidden_dim=128, hidden_layers=4):
        super(ResNetBaseline, self).__init__()
        self.residual_net = MLP(input_dim=input_dim, output_dim=output_dim,
...
if __name__ == "__main__":
    ...
    # # 初始化模型
    model = ResNetBaseline(input_dim=5, output_dim=4, hidden_layers=4, hidden_dim=64).to(device)
