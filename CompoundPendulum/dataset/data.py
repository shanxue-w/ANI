...
data_train = sio.loadmat('compound_train_data.mat')
data_val = sio.loadmat('compound_val_data.mat')
data_traj = sio.loadmat('compound_test_trajectories.mat')
# print(data_train)
...
# data_small_traj = sio.loadmat('compound_test_trajectories_small.mat')
