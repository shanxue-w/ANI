...
import os
# 从 ANI2.py 导入模型类和配置
from base import Baseline_Hydro, BASIN_ID, DATA_FILE, HIDDEN_DIM, SEQ_LEN, device
...
# 模型权重文件
MODEL_PATH = f"Baseline_Best_{BASIN_ID}.pth"
...
def run_test():
    ...
    plt.plot(preds, label='Predicted (Baseline)', color='red', alpha=0.8, lw=1.2, ls='--')
...
# # ================= 配置 =================
# MODEL_PATH = f"Baseline_Best_{BASIN_ID}.pth"  # 确保加载的是优化后的模型
