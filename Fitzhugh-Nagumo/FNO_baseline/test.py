...
from FNO_baseline import AllenCahn
import numpy as np
...
dt_tensor = torch.tensor(0.01 / 2, dtype=torch.float64).to(device)
...
if __name__ == "__main__":
    # 加载模型
    model = AllenCahn(modes1=8, modes2=8, width=20, dt=0.01).to(device)
