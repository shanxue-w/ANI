...
data_FNO = pd.read_csv('NEW_baseline/traj_error_base.txt', sep='\t').iloc[0:101]
...
plt.ylabel(r'Average Relative $L^2$ Error', fontsize=14)
# plt.yscale('log')
plt.grid(True, alpha=0.3)
plt.legend()
plt.tight_layout()
plt.savefig('traj_error_newbaseline.pdf', format='pdf', bbox_inches='tight', dpi=300)
# plt.show()
plt.close()
