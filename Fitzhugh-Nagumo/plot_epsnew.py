...
methods = ['Baseline', '2th', '4th']  # 文件读取名
plot_labels = {'Baseline': 'Baseline', '2th': 'ANI-2', '4th': 'ANI-4'}  # 图中显示名
...
plt.tight_layout()
plt.savefig('line_comparison_t99_newbaseline.pdf', format='pdf', bbox_inches='tight', dpi=300)
# plt.show()
