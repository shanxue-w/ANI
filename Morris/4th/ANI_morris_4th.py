...
class Maki(ANIBASE):
    def __init__(self, N0_SCHEME: N0, input_dim: int, output_dim: int, hidden_layers: int = 4, hidden_dim: int = 64):
        super(Maki, self).__init__(N0_SCHEME, input_dim, output_dim, hidden_layers, hidden_dim)
...
if __name__ == "__main__":
    ...
    # # 初始化模型
    model = Maki(N0_SCHEME=A(mu, sigma), input_dim=3, output_dim=2, hidden_layers=4, hidden_dim=30).to(device)
