...
plot_error(abs_ANI_2th, None, abs_ANI_4th, abs_resnet, 'rel_error_1000.png')
...
plt.figure(figsize=(8, 6))
plt.plot(abs_resnet[1:200, 0:1], label='Forward Euler', linewidth=2, color="#0072B2")
plt.plot(data_2th_abs[1:200, 0:1], label="ANI-2", linewidth=2, color="#009E73")
# plt.plot(data_3th_abs[1:200, 0:1], label="3th Split", linewidth=2)
plt.plot(data_4th_abs[1:200, 0:1], label="ANI-4", linewidth=2, color="#E69F00")

plt.yscale("log")
plt.xlabel("Time Step", fontsize=14)
# plt.ylabel(r"$V$ Error", fontsize=14)
plt.ylabel(r"$|V - V_{\mathrm{ref}}|$", fontsize=14)
plt.legend()
plt.grid(True)
plt.tight_layout()
...
plt.figure(figsize=(8, 6))
plt.plot(abs_resnet[1:200, 1:2], label='Forward Euler', linewidth=2, color="#0072B2")
plt.plot(data_2th_abs[1:200, 1:2], label="ANI-2", linewidth=2, color="#009E73")
# plt.plot(data_3th_abs[1:200, 1:2], label="3th Split", linewidth=2)
plt.plot(data_4th_abs[1:200, 1:2], label="ANI-4", linewidth=2, color="#E69F00")

plt.yscale("log")
plt.xlabel("Time Step", fontsize=14)
# plt.ylabel(r"$w$ Error", fontsize=14)
plt.ylabel(r"$|w - w_{\mathrm{ref}}|$", fontsize=14)
plt.legend()
plt.grid(True)
plt.tight_layout()
...
plt.plot(u_traj[:, 0], color="#1f77b4", linewidth=0.4)
# plt.plot(u_traj[:, 0], color="gray")
plt.axis("off")
plt.gca().set_frame_on(False)
plt.tight_layout()
plt.savefig("u_traj_1.pdf", format='pdf', bbox_inches='tight', pad_inches=0, dpi=300, transparent=True)
plt.close()

# plt.figure(figsize=(8, 8))
plt.figure(figsize=(2*cm, 2*cm))
plt.plot(u_traj[:, 1], color="#1f77b4", linewidth=0.4)
# plt.plot(u_traj[:, 1], color="gray")
plt.axis("off")
plt.gca().set_frame_on(False)
plt.tight_layout()
plt.savefig("u_traj_2.pdf", format='pdf', bbox_inches='tight', pad_inches=0, dpi=300, transparent=True)
plt.close()
